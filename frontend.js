...
const cssValueSuggestionsByProperty = {
  ...
  "text-decoration-color": ["currentColor", "transparent", "#000", "#fff", "red", "blue", "green"],
  ...
  "border-color": ["currentColor", "transparent", "#000", "#fff", "red", "blue", "green"],
  "outline-style": ["none", "solid", "dashed", "dotted"],
  "outline-width": ["0", "1px", "2px", "4px"],
  "outline-color": ["currentColor", "transparent", "#000", "#fff", "red", "blue", "green"],
